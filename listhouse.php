	   ...
	   '<font style="padding-left:10px;">'.$result['middlenm'].'</font>
        <font style="padding-left:10px;">'.$result['lastnm'].'</font><br/>
	     ...
	     <font style="color:#FF9999">City:</font>'.$result['city'] .'<br/>
		  ...
		  .'</font>';
		  echo  " <a href='delhousebyuser.php?id=$result[id]' onclick='return checkdelete()' style='background-color:#CCCCCC; color:#000000; width:100px; height:20px; float:right'><center>Delete</center></a>
	  </div></div>";
