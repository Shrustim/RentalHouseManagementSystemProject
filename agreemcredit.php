...
<title>Appointment from credit card</title>
</head>
...
<form action="agrecredit2.php" method="POST"  enctype="multipart/form-data"  >
      ...
      <h4> AdharNo:<br/>     
        ...
        <br/>
         Cvv:<br/>
        <center> <input type="text" size="40" maxlength="3" name="cvv" value="" /></center>
      <br/>
	  ...
	  <br/>
	   Address:<br/><center><textarea name="address" cols="40" > </textarea>
	   </center>
       <br/>
	  Appointment Date (yyyy-mm-dd):<br/><center>
         <input placeholder="yyyy-mm-dd" type="text" size="40" maxlength="50" name="appointdate" value="" /> </center>
       <br/>
	  ...
	  <br/>
         ...
         No of Visits:<br/>
        <center> <input type="text" size="40" maxlength="2" name="novisits" value="" /></center>
      <br/>
