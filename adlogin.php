...
<body>
  ...
  <div style="box-shadow: 0 5px 10px white;">
    ...
    <a href="contact.php"><h1  class="boxx"  style="top:20%;
      ...
      left:76%;background: linear-gradient(110deg,#999999,#990033,#990066,#990066);">Login</h1></a>
 ...
 <center>
   ...
   <a href="admin.php"> <h3 style="color:#CCFFFF; margin:30px,30px,30px;" ><u>Admin Login</u></h3></a>
	</p>
	</center>
   </div>
</div>
