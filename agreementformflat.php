...
<title>Rent agreement of flat</title>
<style>
body{
  margin:0;
  padding:0;
...
<form action="agreemformflatbb.php" method="post">
<center>
...
Contact Details
  ...
  Flat No:
  <input type="text" name="flatno" maxlength="20" size="24" value="" />
...
<center>
  ...
  Age:
  <input type="text" name="tage" maxlength="10" size="20" value=""  />
   UID(adhar no):
...
Contact Details
 ...
 <font style=" font-size:19px;" >
  ...
  Flat No:
  <input type="text" name="pflatno" maxlength="50" size="6" value="" />
   Floor No:
  <input type="text" name="pfloorno" maxlength="50" size="6" value="" />
...
<select name="ac" style="padding-left:40px; padding-right:40px;">
 ...
 <font style=" font-size:19px;" >
  ...
  <input type="text" name="month" maxlength="3" size="6" value=""  />
  <br/><br/>
  ...
  <input type="text" name="depositeamount" maxlength="50" size="34" value=""  />
   ...
   Lock-in Period(months)Usually 6 months:
     <input type="text" name="lockinperiod" maxlength="3" size="33"  value=""  />	<br/><br/>
