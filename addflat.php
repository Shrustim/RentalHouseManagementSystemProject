...
<center>     <p>
    <form action="addf.php" method="POST"  enctype="multipart/form-data"  >
      ...
      <br/>
	   Home Id:<br/>
        <center> <input type="text" size="40" maxlength="10" name="hid" value="" /></center>
        <br/>
     ...
     Images of house:<br/><br/>
      ...
      <input type="file" name="uploadfile" value=""/> <br/><br/>
       ...
       <br/>
       Deposite of Flat :<br/><center><input  type="text" size="40" maxlength="20" name="deposite" value="" /></center>
       <br/>
