...
if(isset($_POST['submit']))
{
     ...
     if(!empty($name) && !empty($middlenm) && !empty($lastnm) && !empty($city) && !empty($area) && !empty($hid) && !empty($add) && !empty($floorno) && 
      !empty($formatofflat) && !empty($email)  && !empty($mobno) && !empty($desc) &&  !empty($folder)  &&  !empty($folder2)  &&  !empty($rent) &&  !empty($deposite))
     {
    ...
    //description  validation 
          ...
          {  
             $error=true;
            echo "<script type='text/javascript'>alert('deposite rupees must contain numbers!')
               </script>";
