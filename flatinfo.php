...
<ul>
   ...
   <li style="background: linear-gradient(110deg,#999999,#990033,#990066,#990066);"> <a href="flatinfo.php" style="font-size:18px;"  >flatinfo</a></li>
...
<h1 style="color:#FFFFFF; font-size:24px" align="center"><i><u>Flat Information</u></i></h1>
<center>
<div>
<?php 
...
<?php while($result=mysqli_fetch_assoc($data))
  ...
  <td><a href='editflatinfo.php?id=$result[id]&fname=$result[name]&mname=$result[middlenm]&lname=$result[lastnm]&city=$result[city]&area=$result[area]&hid=$result[hid]
  &add=$result[address]&floorno=$result[floorno]
  &foh=$result[formatofflat]&email=$result[email]
  &mob=$result[mobileno]&descrip=$result[desc]&rent=$result[rent]&deposit=$result[deposit]
  '>Edit</a></td>
<td><a href='deleteflat.php?id=$result[id]' onclick='return checkdelete()'>Delete</a></td>
