...
<ul>
   ...
   <li> <a href="flatinfo.php" style="font-size:18px;"  >flatinfo</a></li>
    ...
    <li style="background: linear-gradient(110deg,#999999,#990033,#990066,#990066);"> <a href="godowninffo.php" style="font-size:18px;" >godowninfo</a></li>
...
<h1 style="color:#FFFFFF; font-size:24px" align="center"><i><u>Godown Information</u></i></h1>
<center>
<div>
<?php 
...
<?php while($result=mysqli_fetch_assoc($data))
  ...
  <td><a href='editgodowninfo.php?id=$result[id]&fname=$result[name]&mname=$result[middlenm]&lname=$result[lastnm]&godownnm=$result[godownnm]
  ...
  '>Edit</a></td>
<td><a href='deletegodown.php?id=$result[id]' onclick='return checkdelete()'>Delete</a></td>
