...
<h1 style="color:#FFFFFF; font-size:24px;margin-left:440px;" ><i><u>Next Day Appointments for Biometric Information</u></i> 

<div>
<?php 
$currentdate=date("Y-m-d",strtotime("1 day"));
$query="SELECT * FROM  `agreemcredit` WHERE appointdate=$currentdate";
         
  $data=mysqli_query($conn,$query);
$total=mysqli_num_rows($data);

$query2="SELECT * FROM  `agreemdebit` WHERE appointdate=$currentdate";
...
while($result=mysqli_fetch_assoc($data))
  ...
  {
  echo "<script type='text/javascript'>alert('There is no appointments Next Day !!!!!!')
               </script>"; 
