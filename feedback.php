...
<ul>
     <li> <a href="adminb.php">Home</a></li>
	   <li style="background: linear-gradient(110deg,#999999,#990033,#990066,#990066);"> <a href="feedback.php" style="font-size:18px;" >Feedback</a></li>
...
<h1 style="color:#FFFFFF; font-size:24px" align="center"><i><u>Feedback</u></i></h1>
<center>
<div>
<?php 
...
<td><a href='deletefeedback.php?id=$result[id]' onclick='return checkdelete()'>Delete</a></td>
...
{
 return confirm('Are you sure you want to delete this feedback data???');
}
