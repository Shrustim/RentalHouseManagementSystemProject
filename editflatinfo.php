...
<div class="content">
    <h1 style="text-shadow:5px 5px 9px yellow;">UPDATE FLAT</h1> 
<center>     <p>
    <form action="" method="POST"  enctype="multipart/form-data"  >
      ...
      <br/>
	   ...
	   Home Id:<br/>
        <center> <input type="text" size="40" maxlength="40" name="hid" value="<?php echo $_GET['hid']; ?>"/></center>
		<br/>
        Full Address:<br/><center>
          <input  type="text" size="40" maxlength="200" name="address" value="<?php echo $_GET['add']; ?>" /></center>
       <br/>
	   Floor No:<br/>
        <center> <input type="text" size="40" maxlength="40" name="floorno" value="<?php echo $_GET['floorno']; ?>" /></center>
		<br/>
	   Format oh house:<br/>
         ...
         $mobno=($_POST['mobile'] ); 
          ...
          $desc=($_POST['desc'] ); 
			 ...
			 $deposite=($_POST['deposite'] );
			    ...
			    $query="UPDATE `flatlist` SET name='$name',middlenm='$middlenm',lastnm='$lastnm',
				city='$city',area='$area',hid='$hid',address='$add',floorno='$floorno',formatofflat='$formatofflat',
				email='$email',mobileno='$mobno',`desc`='$desc',
				rent='$rent',deposit='$deposite'  WHERE id='$id' ";
                      ...
                      if($is_query_run=mysqli_query($conn,$query))
                       {  //Insert into database Query
                          // echo " query executed";
                         echo "<script type='text/javascript'>alert('Flat information Updated succssesfully !')
                         </script>";

                         
                echo "<script language='javascript' type='text/javascript'>location.href='flatinfo.php'
               </script>";
