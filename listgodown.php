	   ...
	   '<font style="padding-left:10px;">'.$result['middlenm'].'</font>
	    ...
	    <font style="color:#FF9999">Godown Name:</font>'.$result['godownnm'].'<br/>
		 ...
		 <font style="color:#FF9999">Deposite:</font>' .$result['deposit'] .'<br/>'
		  .'</font>';
		  echo  " <a href='delgodownbyuser.php?id=$result[id]' onclick='return checkdelete()' style='background-color:#CCCCCC; color:#000000; width:100px; height:20px; float:right'><center>Delete</center></a>
	  </div></div>";
