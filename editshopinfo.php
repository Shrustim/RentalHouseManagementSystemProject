...
<div class="content">
    <h1 style="text-shadow:5px 5px 9px yellow;">UPDATE SHOP</h1> 
<center>     <p>
    <form action="" method="POST"  enctype="multipart/form-data"  >
      ...
      <h4>  Firstname of Owner:<br/>     
	   ...
	   Shop Name :<br/>
	   <center><input type="text" size="40" maxlength="50" name="shopnm" value="<?php echo $_GET['shopnm']; ?>" /></center>
	   <br/>
         ...
         $mobno=($_POST['mobile'] ); 
          ...
          $desc=($_POST['desc'] ); 
			 ...
			 $deposite=($_POST['deposite'] );
			    ...
			    $query="UPDATE `shop` SET name='$name',middlenm='$middlenm',lastnm='$lastnm',shopnm='$shopnm',city='$city',
				...
				rent='$rent',deposit='$deposite'  WHERE id='$id' ";
                      ...
                      if($is_query_run=mysqli_query($conn,$query))
                       {  //Insert into database Query
                          // echo " query executed";
                         echo "<script type='text/javascript'>alert('Shop information Updated succssesfully !')
                         </script>";

                         
                echo "<script language='javascript' type='text/javascript'>location.href='shopinfo.php'
               </script>";
