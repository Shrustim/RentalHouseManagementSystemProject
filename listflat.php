...
{   while($result=mysqli_fetch_assoc($data))
   {  
       ...
       <div id="sliderbox"><img src="'.$result['folder1'].'" width="350px" height="250px" /><img src="'.$result['folder2'].'" width="350px" height="250px" /></div></div></center>
	   ...
	   '<font style="padding-left:10px;">'.$result['middlenm'].'</font>
        <font style="padding-left:10px;">'.$result['lastnm'].'</font><br/>
	     ...
	     <font style="color:#FF9999">City:</font>'.$result['city'] .'<br/>
		  ...
		  .'</font>';
		 echo  " <a href='delflatbyuser.php?id=$result[id]' onclick='return checkdelete()' style='background-color:#CCCCCC; color:#000000; width:100px; height:20px; float:right'><center>Delete</center></a>
	  </div></div>";
