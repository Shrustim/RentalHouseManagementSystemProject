...
<title>Rent agreement of shop</title>
<style>
body{
  margin:0;
  padding:0;
...
<form action="agreemformshopbb.php" method="post">
<center>
...
Contact Details
 ...
 <font style=" font-size:19px;" >
  <p align="justify"  style="padding-left:35px;">
	 ...
	 <select name="propertytype" style="padding-left:20px; padding-right:20px;">
	   ...
	   Area (sq.ft):
  <input type="text" name="areasqft" maxlength="50" size="32"  value="" />
 ...
 <font style=" font-size:19px;" >
  <p align="justify"  style="padding-left:35px;">
   ...
   Monthly Rent:
  <input type="text" name="montlyrent" maxlength="50" size="12"   value="" />
