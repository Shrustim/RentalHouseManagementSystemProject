...
<ul>
   ...
   <li style="background: linear-gradient(110deg,#999999,#990033,#990066,#990066);"> <a href="houseinfo.php" style="font-size:18px;" >HousesInfo</a></li>
...
<h1 style="color:#FFFFFF; font-size:24px" align="center"><i><u>House Information</u></i></h1>
<center>
<div>
<?php 
...
<?php while($result=mysqli_fetch_assoc($data))
  ...
  <td><a href='edithouseinfo.php?id=$result[id]&fname=$result[name]&mname=$result[middlenm]&lname=$result[lastnm]&city=$result[city]&area=$result[area]&add=$result[address]
  &foh=$result[formatofhouse]&email=$result[email]
  &mob=$result[mobile]&descrip=$result[descrip]&rent=$result[rent]&deposit=$result[deposit]
  '>Edit</a></td>
<td><a href='deletehouse.php?id=$result[id]' onclick='return checkdelete()'>Delete</a></td>
