...
<center>     <p>
    <form action="" method="POST"  enctype="multipart/form-data"  >
      ...
      <h4> Adhar No:   <input style="margin-left:130px;" type="text" size="40" maxlength="40" name="adharno" value="<?php echo $_GET['adharno']; ?>" /> 
         <br/><br/>
        Card No:  <input style="margin-left:140px;" type="text" size="40" maxlength="40" name="cardno" value="<?php echo $_GET['cardno']; ?>" />
         ...
         <br/><br/>
          Email:<input style="margin-left:170px;" type="text" size="40" maxlength="10" name="email" value="<?php echo $_GET['email']; ?>" />
...
if(isset($_POST['submit']))
{
         ...
         $email=($_POST['email'] ); 
		    ...
		    $query="UPDATE `creditmembership` SET adharno='$adh',cardno='$cardno',cardholder='$ch',email='$email'
   WHERE id='$id'";
                      ...
                      if($is_query_run=mysqli_query($conn,$query))
                       {  //Insert into database Query
                          // echo " query executed";
                         echo "<script type='text/javascript'>alert('Update Membership Sucssesfully')
                         </script>";

                         echo "<script language='javascript' type='text/javascript'>location.href='membershipinfo.php'
               </script>";
